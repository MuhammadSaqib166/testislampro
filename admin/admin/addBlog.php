...
if(isset($_POST['submit'])){
    ...
    if (move_uploaded_file($tmp_name, $image_path)) {
      ...
      $sql = "INSERT INTO blogs (title, image, description) VALUES ('$title', '$image_path', '$description')";
      ...
      if (mysqli_query($conn, $sql)) {
          ...
          // There was an error adding the new darood to the database
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" class="form-horizontal form-material" enctype='multipart/form-data'>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button type="submit" name="submit" class="btn btn-success">Add Blog</button>
                                        </div>
                                    </div>
