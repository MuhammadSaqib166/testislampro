...
$sql = "INSERT INTO daroods (title, darood) VALUES ('$title', '$darood')";

// Execute the SQL statement
if (mysqli_query($conn, $sql)) {
    // The new user has been added to the database successfully
    $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2">Darood Added successfully</div>';
} else {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Arabic "
                                                class="form-control form-control-line" name="darood"
                                                id="darood">
                                        </div>
                                    </div>
                                    <div class="form-group">
